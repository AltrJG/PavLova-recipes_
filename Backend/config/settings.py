...
MIDDLEWARE = [
    ...
    'apps.core.logging.middleware.RequestContextLogMiddleware',
...
LOGGING = {
    ...
    'formatters': {
        'json': {
            ...
            'format': '%(asctime)s %(levelname)s %(name)s %(message)s %(trace_id)s %(user_id)s %(ip_address)s'
        },
    },
    'filters': {
        'request_context': {
            '()': 'apps.core.logging.context.RequestContextFilter',
        },
        'mask_sensitive_data': {
    ...
    'handlers': {
        'console': {
            ...
            'formatter': 'json',
            'filters': ['request_context', 'mask_sensitive_data'],
        },
    },
    'loggers': {
        '': {
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    'EXCEPTION_HANDLER': 'apps.core.logging.exception_handler.global_exception_handler',
}

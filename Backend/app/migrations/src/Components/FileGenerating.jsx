    ...
    <div className={`${styles.container} ${canShow ? styles.showComponent : ""}`}>
      ...
      <div className={styles.content}>
        <div className={styles.svgAnimation}>
            <div className={styles.svgStart}><ReactSVG src={`/assets/Iconos/${svg_start}.svg`}/></div>
            <div className={styles.svgMiddle}><ReactSVG src={`/assets/Iconos/arrow-forward-circle.svg`}/></div>
            <div className={styles.svgEnd}><ReactSVG src={`/assets/Iconos/${svg_end}.svg`}/></div>
        </div>

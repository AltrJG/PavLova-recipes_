    ...
    return(
        <section className={styles.planAlimenticioContainer}>
            ...
            <div className={styles.planAlimenticioSeparation}>
                <div className={`${styles.planMainContent} ${activeRecipes.length <= 0 ? styles.hiddenMainContent : ''}`}>
                    ...
                    <div className={`${styles.objectiveCharts} ${activeRecipes.length <= 0 ? styles.hiddenObjectiveCharts : ''}`}>
